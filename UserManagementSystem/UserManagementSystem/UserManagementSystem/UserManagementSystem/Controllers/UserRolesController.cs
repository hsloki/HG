...
namespace UserManagementSystem.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public ActionResult AllUsers()
        {
            ...
            var client = new RestClient(ServerBaseUrl + "UserRoles/GetAllUsers");
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/GetUserByID");
            RestRequest request = new RestRequest(Method.GET);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/GetAllRoles");
            RestRequest request = new RestRequest(Method.GET);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/GetUserRole");
            RestRequest request = new RestRequest(Method.GET);
            request.AddParameter("id", id);
        ...
        {
            // get user to update db using api. 
            var client = new RestClient(ServerBaseUrl + "UserRoles/UpdateRole");
            RestRequest request = new RestRequest(Method.POST);
            request.AddObject(role);
            var response = client.Execute(request);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/DeleteUser");
            RestRequest request = new RestRequest(Method.GET);
            request.AddParameter("id", id);
            var response = client.Execute(request);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/DeleteRole");
            RestRequest request = new RestRequest(Method.GET);
            request.AddParameter("id", id);
            var response = client.Execute(request);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/GetRolesOfUser");
            RestRequest request = new RestRequest(Method.GET);
        ...
        public ActionResult DeleteRoleFromUser(int? UserID, int? RoleID)
        {
            ...
            var client = new RestClient(ServerBaseUrl + "UserRoles/RemoveRoleFromUser?UserID=" + UserID + "&RoleID=" + RoleID);
            RestRequest request = new RestRequest(Method.GET);
        ...
        {
            var client = new RestClient(ServerBaseUrl + "UserRoles/AddRoleToUser?UserID=" + hdUserID + "&RoleID=" + hdUserRole);
            RestRequest request = new RestRequest(Method.GET);
            //request.AddParameter("UserID", UserID);
            //request.AddParameter("RoleID", RoleID);
            var response = client.Execute(request);
